...
<section class="course-registration">
    <div class="personal-cabinet-container2 course-registration__container">
        ...
        <h1 class="personal-cabinet__title course-registration__title">
            Курс категории С по горнолыжному спорту. Инструктор начального уровня
        </h1>
        <a href="" class="course-registration__link gradient-colored-text">
            Подробнее о курсе
        </a>
        <div class="flex-wrap personal-cabinet__flex-container course-registration__flex-container">
            <div class="personal-cabinet-container2__col course-registration__col">
                ...
                <ul class="steps">
                    <li class="steps__item _is-done" data-step="1">
                        ...
                        <form action="test.php" class="validate form" name="reg-course-step2">
                            ...
                            <div class="steps__body" style="display: none;">
                                <div class="steps__content">
                                    <p class="steps__warning _saved-data">
                                        Ранее вы заполняли заявки на курсы НЛИ, ваши данные будут автоматически загружены. Перед отправкой, проверьте их корректность
                                    </p>
                                    <div class="tabs">
                                        ...
                                        <div class="steps__fiz-lico" data-item="fizLico">
                                            <div class="steps__content-block">
                                                ...
                                                <div class="flex-wrap steps__flex-wrap _magrin-bottom">
                                                    ...
                                                    <div class="input-container steps__small-input">
                                                        <input type="tel" class="input required required-el" data-mask="passwordkod" name="password-code">
                                                        <span class="input-heading">
                                                            Код подразделения
                                                        </span>
                                                    </div>
                                    ...
                                    <div class="steps__content-block tabs deliveryTabs">
                                        ...
                                        <div class="" data-item="delivery" style="display: none;">
                                            ...
                                            <div class="flex-wrap _space-between _mobile-delivery-wrap">
                                                <div class="input-container _50width">
                                                    <input type="text" class="input required-el" data-mask="letters" disabled name="delivery-region">
                                                    <span class="input-heading">
                                                        Регион
                                                    </span>
                                                </div>
                                            ...
                                            <div class="flex-wrap steps__flex-wrap">
                                                ...
                                                <div class="input-container steps__small-input">
                                                    <input type="text" class="input required-el" data-mask="digits" disabled name="delivery-korpus">
                                                    <span class="input-heading">
                                                        Корпус
                                                    </span>
                                                </div>
                                                <div class="input-container steps__small-input">
                                                    <input type="text" class="input required-el" data-mask="digits" disabled name="delivery-office">
                                                    <span class="input-heading">
                                                        Кв/Офис
                                                    </span>
                                                </div>
                                ...
                                <div class="steps__content">
                                    ...
                                    <div class="step-is-closed">
                                        ...
                                        <div class="steps__file-block">
                                            ...
                                            <a href="" class="flex-wrap _space-between _flex-start steps__file-flex-wrap steps__doc-dwnld-link">
                                                <span class="steps__legend _file-legend">
                                            ...
                                            <label class="input-file-container file steps__file dropFile">
                                                <input type="file" name="cheque" class="input-file visually-hidden required">
                                                <span class="file__empty flex-wrap file__flex-wrap">
                                                    <svg class="icon file__icon-file">
                                                        <use xlink:href="../assets/img/sprite.svg#icon-file"></use>
                                                    </svg>
                ...
                <div class="course-registration__interested may-be-interested">
                    <span class="may-be-interested__heading">
                        Вам может быть интересно
                    </span>
                    <div class="may-be-interested__items">
                        <a href="" class="may-be-interested__item _green-colored">
                           <span class="may-be-interested__item-heading">
                               Соревнования
                           </span>
                           <span class="may-be-interested__item-price">
                                2 590 ₽
                           </span>

                           <div class="may-be-interested__item-button">
                               Купить
                           </div>
                           <svg class="icon icon-designed-arrows">
                                <use xlink:href="../assets/img/sprite.svg#designed-arrows"></use>
                            </svg>
                        </a>
                        <a href="" class="may-be-interested__item _red-colored">
                           <span class="may-be-interested__item-heading">
                            Английский язык
                           </span>
                           <span class="may-be-interested__item-price">
                ...
                <div class="course-registration__side-block side-block">
                    ...
                    <div class="side-block__row-wrap">
                        ...
                        <div class="side-block__row">
                            ...
                            <div class="side-block__info _discount">
                                – 1000 ₽
                            </div>
                        </div>
                        
                        <div class="side-block__row _promocode-row">
                            <span class="side-block__legend">
                                Скидка по промокоду
                            </span>
                            <div class="side-block__info">
                    ...
                    <div class="side-block__total-row">
                        ...
                        <div class="side-block__summ-price">
                            32 800 ₽
                    ...
                    <div class="side-block__promocode_wrap">
                        <form action="test.php" class="side-block__promocode validate" name="promocode">
                            <div class="_wrap flex-wrap">
                                <div class="input-container">
                                    <input type="text" class="input required required-el" name="promocode">
                                    <span class="input-heading">
                                        Промокод
                                    </span>
                                </div>
                                <button type="submit" class="button-reset side-block__promocode-button">
                                    <svg class="icon side-block__promocode-icon">
                                        <use xlink:href="../assets/img/sprite.svg#promocode-arrow"></use>
                                    </svg>
                                    <svg class="icon side-block__promocode-icon-success">
                                        <use xlink:href="../assets/img/sprite.svg#valid-icon"></use>
                                    </svg>
                                </button>
                            </div>
                        </form>
                        
                        <button class="button-reset side-block__reset-button">
                    ...
                    <button class="button-reset button side-block__pay-button " data-popup="modalCoursePayment">
                        Оплатить сейчас
                    </button>

                    <span class="side-block__attention-pay">
                        Сумма без учета доп. расходов
                        <svg class="icon side-block__icon-question">
                            <use xlink:href="../assets/img/sprite.svg#question"></use>
                        </svg>
                    </span>
                </div>
                <p class="course-registration__pay-wraning">
                    <svg class="icon course-registration__icon-warn">
                        <use xlink:href="../assets/img/sprite.svg#warn"></use>
                    </svg>
                    Вы можете оплатить курс после 2-ого или 3-ого шага анкеты
                </p>
            </div>
        </div>
    </div>
